<?php
if(class_exists('Gcx_Mailpoet_Ex_Option_Namespace')) {
    return;
}

class Gcx_Mailpoet_Ex_Option_Namespace implements Gcx_Mailpoet_Ex_Configurable_Interface{
    ...
    protected function get_new_option(){
        return Gcx_Mailpoet_Ex_CF::create("Option");
