<?php
if(class_exists("Gcx_Mailpoet_Ex_Remote_Action_Setoption")){
    return;
}

class Gcx_Mailpoet_Ex_Remote_Action_Setoption  implements Gcx_Mailpoet_Ex_Remote_Action_Interface {
    protected $_request;
