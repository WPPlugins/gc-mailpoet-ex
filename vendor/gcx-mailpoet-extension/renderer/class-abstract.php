<?php
if(class_exists("Gcx_Mailpoet_Ex_Abstract_Renderer")){
    return;
}
abstract class Gcx_Mailpoet_Ex_Abstract_Renderer{
    protected $namespace;
    ...
    protected function get_repository_factory(){
        return Gcx_Mailpoet_Ex_CF::create("Option_Repository_Factory");
    }
    ...
    public function get_event_manager(){
      if($this->event_manager == null){
        $this->event_manager = Gcx_Mailpoet_Ex_CF::create_and_init("Event_Manager",array("global" => true, "namespace"=> "get_conversion"));
      } 
