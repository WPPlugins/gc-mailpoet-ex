<?php
if(class_exists("Gcx_Mailpoet_Ex_Mygetconversion_Worker")){
    return;
}
class Gcx_Mailpoet_Ex_Mygetconversion_Worker{
        ...
        public function execute($request){
            ...
            try{
                ...
                $request_params = Gcx_Mailpoet_Ex_CF::create_and_init("Request",$params);
        ...
        protected function send_global_worker_output(){
            global $GC_Mygetconversion_Worker;            
            $_output_formatter = Gcx_Mailpoet_Ex_CF::create("Remote_Action_Output_Json");
