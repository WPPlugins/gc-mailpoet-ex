<?php
if(class_exists("Gcx_Mailpoet_Ex_Setting_Parameter_Base")){
    return;
}
class Gcx_Mailpoet_Ex_Setting_Parameter_Base 
implements
        Gcx_Mailpoet_Ex_Testable_Interface    
{
    /* #REGION $id */
    protected $id ="";
    ...
    /* #REGION Gcx_Mailpoet_Ex_Testable_Interface */
    /* #REGION $variant */
