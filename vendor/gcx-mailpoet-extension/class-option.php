<?php
if(class_exists("Gcx_Mailpoet_Ex_Option")){
    return;
}
class Gcx_Mailpoet_Ex_Option implements Gcx_Mailpoet_Ex_Option_Interface, 
                           Gcx_Mailpoet_Ex_Option_Meta_Data_Interface,
