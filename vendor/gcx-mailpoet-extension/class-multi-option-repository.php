<?php
if(class_exists('Gcx_Mailpoet_Ex_Multi_Option_Repository')) {
    return;
}
class Gcx_Mailpoet_Ex_Multi_Option_Repository extends Gcx_Mailpoet_Ex_Option_Repository{
    ...
    protected function get_store(){
        ...
        if(!Gcx_Mailpoet_Ex_Service_Locator::has("multi_option_store")){
            throw new Exception("No option store engine");
        }
        $this->store = Gcx_Mailpoet_Ex_Service_Locator::get("multi_option_store");
        return $this->store;
    }
