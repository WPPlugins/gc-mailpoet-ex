...
class Gcx_Mailpoet_Ex_Event_Manager 
implements
    Gcx_Mailpoet_Ex_Configurable_Interface
{
    ...
    public function configure(array $options){
        ...
        $this->store = new Gcx_Mailpoet_Ex_Registry();
    ...
    public function dispatch($event, Gcx_Mailpoet_Ex_Event $event_data,$before_after_event_call = false){
